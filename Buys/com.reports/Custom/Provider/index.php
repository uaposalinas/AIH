        ...
        <div class="Table">
            ...
            <div class="Logs">
                ...
                <?php
                    ...
                    $DoQuery = "SELECT * FROM logs WHERE Provider = '$Value'";
    ...
    <div class="ShowAllResults">
     ...
     <t class="PerMonthsLogTitle" style="width: 10000px;">Totalizaciones de Registros del Reporte Personalizado</t>
        ...
        <?php
            ...
            $DoQuery = "SELECT Exempt FROM logs WHERE Provider = '$Value'";
            ...
            <?php
                ...
                $DoQuery = "SELECT ISV15 FROM logs WHERE Provider = '$Value'";
            ...
            <!--ISV 18-->
                ...
                <?php
                    ...
                    $DoQuery = "SELECT ISV18 FROM logs WHERE Provider = '$Value'";
            ...
            <?php
                ...
                $DoQuery = "SELECT OtherISV FROM logs WHERE Provider = '$Value'";
        ...
        <!--OtherISV-->
            ...
            $DoQuery = "SELECT Total FROM logs WHERE Provider = '$Value'";
