...
<div class="LeftZoneHeader">
    ...
    <t>Reporte Personalizado de Compras</t>
        ...
        <div class="Table">
            ...
            <div class="Logs">
                ...
                <?php
                    ...
                    $DoQuery = "SELECT * FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
    ...
    <div class="ShowAllResults">
     ...
     <t class="PerMonthsLogTitle" style="width: 10000px;">Totalizaciones de Registros del Reporte Personalizado</t>
        ...
        <?php
            ...
            $DoQuery = "SELECT Exempt FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
            ...
            <?php
                ...
                $DoQuery = "SELECT ISV15 FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
            ...
            <!--ISV 18-->
                ...
                <?php
                    ...
                    $DoQuery = "SELECT ISV18 FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
            ...
            <?php
                ...
                $DoQuery = "SELECT OtherISV FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
        ...
        <!--OtherISV-->
            ...
            $DoQuery = "SELECT Total FROM logs WHERE Date BETWEEN '$From' AND '$Until' AND Provider = '$Provider';";
