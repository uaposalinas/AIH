...
document.querySelector('.BackButton').addEventListener('click', e=>{
    ...
    $GetFilterModel = $_GET["Filter"];
    $GetAllDevTestResults = "SELECT TestID, Brand, Model, Serial, ScreenTest, TouchPadTest, TouchScreenTest, LeftSpeakerTest, RightSpeakerTest, UsbPortsTest, HdmiPortTest, BatteryLifePercentage, ChargerTest, MicrophoneTest, CameraTest, KeyboardTest, TestStatus, TestCode FROM DevTestResults WHERE Model = '$GetFilterModel'";
