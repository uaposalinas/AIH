...
$GetAllDevTestResults = "SELECT TestID, Brand, Model, Serial, ScreenTest, TouchPadTest, TouchScreenTest, LeftSpeakerTest, RightSpeakerTest, UsbPortsTest, HdmiPortTest, BatteryLifePercentage, ChargerTest, MicrophoneTest, CameraTest, KeyboardTest, TestStatus, TestCode FROM DevTestResults WHERE Serial = '$GETMethodSerial'";
...
if($GetDevTestConsult -> num_rows > 0){
    ...
    echo "<p style='color:#000000'>This database no content the information that you request, please try again or use a diferent keyword.</p>";
