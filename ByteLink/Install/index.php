...
<head>
    ...
    <link rel="icon" type="image/gif" href="https://cdn-icons-png.flaticon.com/512/685/685388.png">
...
<body>
    ...
    <div class="InstallerBody">

        <div class="WelcomePreloaderPage" style="display: flex;">
        ...
        <?php
            ...
            <div class='Icon' style='background-image:url($IdentiferPicture)'></div>
            <div class='BundleName'>$BundleName</div>
            
            "
        
        ?>

            <bt class="FinishedButtonIns"> Completar </bt>
        ...
        <div class="Privacy" style="display: none;">
            ...
            <div class="Declarate">
                ...
                <div class="Content">
                    ...
                    <p> 
                        ...
                        ¡Bienvenido a DevLabs Teams!<br><br>
                        
                        Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de DevLabs Corporation LLC, ubicado en http://localhost.host.
                        
                        Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando DevLabs Teams si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.
                        
                        Cookies:
                        El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a DevLabs Teams, aceptaste utilizar las cookies necesarias.
                        ...
                        Licencia:
                        A menos que se indique lo contrario, DevLabs Corporation LLC y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en DevLabs Teams. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde DevLabs Teams para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.
                        
                        No debes:
                        
                        Copiar o volver a publicar material de DevLabs Teams
                        Vender, alquilar o sublicenciar material de DevLabs Teams
                        Reproducir, duplicar o copiar material de DevLabs Teams
                        Redistribuir contenido de DevLabs Teams
                        Este acuerdo comenzará el fecha presente.
                        
                        Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. DevLabs Corporation LLC no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de DevLabs Corporation LLC, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, DevLabs Corporation LLC no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.
                        
                        DevLabs Corporation LLC se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
                        ...
                        Por la presente, otorgas a DevLabs Corporation LLC una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
                        ...
                        Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a DevLabs Corporation LLC. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
                        ...
                        No se permitirá el uso del logotipo de DevLabs Corporation LLC u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
            ...
            <div class="NextButton NextToSettings">Acepto</div>

        </div>

        <div class="SetFiles" style="display:none;">

            <div class="Icon"></div>
            <t>Configurando la nueva instancia</t>

            <div class="SetFilesContent">

                <div class="setting"> <div class="IconsContainer"> <div class="Preload Preload1"> <div class="overlay"><div class="spinner center"><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div></div></div></div> <div class="Passed Passed1"></div> <div class="Error Error1"></div> </div> <p>Actualizando Directivas</p> </div>
                <div class="setting"> <div class="IconsContainer"> <div class="Preload Preload2"> <div class="overlay"><div class="spinner center"><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div></div></div></div> <div class="Passed Passed2"></div> <div class="Error Error2"></div> </div> <p>Configurando Slots y puertos</p> </div>
                <div class="setting"> <div class="IconsContainer"> <div class="Preload Preload3"> <div class="overlay"><div class="spinner center"><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div><div class="spinner-blade"></div></div></div></div> <div class="Passed Passed3"></div> <div class="Error Error3"></div> </div> <p>Instalando Módulos</p> </div>

            </div>

        </div>

        <div class="InstallProcess" style="display: none;">

            <div class="Icon InstallProcessIcon"></div>
            <p class="InstallProcessText">Comprobando Todo</p>
            <bt class="FinishedButton"> Siguiente </bt>

        </div>

    </div>

    <script src="com.flash.js"></script>
